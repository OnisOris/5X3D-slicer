...
class ThreeDTool:
    ...
    def point_from_plane_line_intersection(self, line: Line, plane: Plane) -> np.ndarray or None:
        """
    ...
    def slice(self, triangles, thiсk=0.1):
        max_xyz, min_xyz = self.max_min_points(triangles)
        z_min = min_xyz[2]
        z_max = max_xyz[2]
    ...
    def position_analyze_of_triangle(self, triangle, plane: Plane) -> int:
        ...
        point2 = triangle[2]
        point3 = triangle[3]
        var1 = self.position_analyzer_of_point(point1, plane)
        var2 = self.position_analyzer_of_point(point2, plane)
        var3 = self.position_analyzer_of_point(point3, plane)
